...
function loadData() {
	...
	axios.get('api/project_coordinators')
		.then(res => {
...
function addUser() {
	...
	isSubmit.value = true
	axios.defaults.headers.common['Authorization'] = token.value
	axios.post('api/add-project_coordinator', {
		'full_name': full_name.value,
		'email': email.value,
	}).then(() => {
			isHide.value = false
			loadData();
			toast.success("Project Coordinator Successfully Added!!", {
				timeout: 2000
			})
		}).catch(err => {
			errTime.value = true
...
function editUser(){
	...
	axios.defaults.headers.common['Authorization'] = token.value
	isSubmit.value = true
	axios.post('api/update-project_coordinator/'+userId.value, {
		'full_name': full_name.value,
		'email': email.value,
		}).then(() => {
			isHide.value = false
...
<template>
	<div class="page-content">
		...
		<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-2">
			<div class="breadcrumb-title pe-3">Project Coordinator</div>
			<div class="ps-3">
		...
		<div v-if="isHide" class="card border-top border-0 border-4 border-primary">
			<div class="card-body p-5">
				...
				<div class="card-title d-flex align-items-center">
					...
					<h5 class="mb-0 text-primary">Project Coordinator Registration</h5>
				</div>
				<hr>
				<form class="row g-3 ">
					<div class="col-md-6">
