...
function editData(){
	...
	let formdata = new FormData();
		...
		formdata.append("attached_file", attached_file.value);
		formdata.append("document_id", document_id.value);
	axios.post('api/update-comment-proCoor/'+comment_id.value,formdata, {
		headers: {
												...
												<div class="btn-group" role="group"
													...
													<div class="btn-group" role="group">
														...
														<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
															<li v-if="comment.status == 1"><button @click.prevent="showData(comment.id)" class="btn btn-outline-info dropdown-item "><i
															...
															<li v-if="comment.status == 1" ><button  @click.prevent="deleteData(comment.id)"
