        ...
        <div class="row justify-content-lg-center">
                ...
                <div class="course-grid bg-shadow tooltip-style">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="landingpage/assets/images/course/img_06.jpg" alt="" class="img-fluid">
                    ...
                    <div class="course-hover-content">
                        ...
                        <div class="course-meta d-flex align-items-center mb-20">
                            <div class="author me-4">
                                <img src="landingpage/assets/images/course/course-2.jpg" alt="" class="img-fluid">
                                <a href="#">Josephin</a>
                            </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="course-grid bg-shadow tooltip-style">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="landingpage/assets/images/course/img_02.jpg" alt="" class="img-fluid">
                            <div class="course-price">$300</div>
                        </div>
                    </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6">
                <div class="course-grid bg-shadow tooltip-style">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="landingpage/assets/images/course/img_03.jpg" alt="" class="img-fluid">
                            <div class="course-price">$300</div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-1">
                    <div class="course-cat-icon">
                        <img src="landingpage/assets/images/icon/icon1.png" alt="" class="img-fluid">
                    </div>
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-2">
                    <div class="course-cat-icon">
                        <img src="landingpage/assets/images/icon/icon2.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-3">
                    <div class="course-cat-icon">
                        <img src="landingpage/assets/images/icon/icon3.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-4">
                    <div class="course-cat-icon">
                        <img src="landingpage/assets/images/icon/icon4.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
            ...
            <div class="col-xl col-lg-4 col-sm-6">
                <div class="single-course-category style-3 bg-5">
                    <div class="course-cat-icon">
                        <img src="landingpage/assets/images/icon/icon6.png" alt="" class="img-fluid">
                    </div>
                    <div class="course-cat-content">
                        <h4 class="course-cat-title">
            ...
            <div class="col-xl-5">
                <div class="video-section mt-3 mt-xl-0">
                    <div class="video-content">
                        <img src="landingpage/assets/images/bg/office01.html" alt="" class="img-fluid">
        ...
        <div class="row justify-content-lg-center">
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="course-grid tooltip-style bg-white hover-shadow">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="landingpage/assets/images/course/img_01.jpg" alt="" class="img-fluid">
                            <div class="course-price">$300</div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="course-grid tooltip-style bg-white hover-shadow">
                    <div class="course-header">
                        <div class="course-thumb">
                            <img src="landingpage/assets/images/course/img_05.jpg" alt="" class="img-fluid">
                            <div class="course-price">$300</div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item team-item-4 mb-70 mb-xl-0">
                    <div class="team-img">
                        <img src="landingpage/assets/images/team/team-4.jpg" alt="" class="img-fluid">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item team-item-4 mb-70 mb-xl-0">
                    <div class="team-img">
                        <img src="landingpage/assets/images/team/team-1.jpg" alt="" class="img-fluid">
                        <ul class="team-socials list-inline">
                            <li class="list-inline-item"><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="fab fa-twitter"></i></a></li>
                            <li class="list-inline-item"><a href="#"><i class="fab fa-linkedin-in"></i></a></li>
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item team-item-4 mb-70 mb-xl-0">
                    <div class="team-img">
                        <img src="landingpage/assets/images/team/team-2.jpg" alt="" class="img-fluid">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item team-item-4">
                    <div class="team-img">
                        <img src="landingpage/assets/images/team/team-3.jpg" alt="" class="img-fluid">
                           ...
                           <div class="quote-icon"><i class="flaticon-left-quote"></i></div>
                            ...
                            <div class="client-info d-flex align-items-center">
                                <div class="client-img">
                                    <img src="landingpage/assets/images/clients/testimonial-avata-01.jpg" alt="" class="img-fluid">
                                </div>
                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-xl-4 col-lg-5">
                           <div class="cta-img mb-4 mb-lg-0">
                               <img src="landingpage/assets/images/about/img_9.png" alt="" class="img-fluid">
                           </div>
                        </div>
